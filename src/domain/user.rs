...
#[derive(Debug, Builder, Validate, Clone)]
...
impl User {
    ...
    pub fn use_recovery_code(&self, code: &str) -> anyhow::Result<Self> {
        ...
        let new = User {
            active_recovery_codes: new_recovery_codes,
            ..self.clone()
        };
    ...
    pub fn generate_new_recovery_codes(&self) -> anyhow::Result<Self> {
        ...
        let new = User {
            active_recovery_codes: recovery_codes_results
                .iter()
...
mod tests {
    ...
    fn should_fail_to_use_invalid_recovery_code() {
        ...
        let generate_result = user.generate_new_recovery_codes();
